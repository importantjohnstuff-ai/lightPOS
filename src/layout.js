...
import { checkActiveShift } from "./modules/shift.js?v=3";
    ...
    headerActions.innerHTML = `
        ...
        ${canSeeNotifications ? `
            <div class="relative">
                ...
                <div id="notification-dropdown" class="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-xl overflow-hidden z-[100] hidden border border-blue-200 text-gray-800">
